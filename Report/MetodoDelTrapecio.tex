...
\section{Artículo de investigación} \label{sec:paper}
	...
	La Figura \ref{fig:nn-error} muestra la imagen de la red neuronal calculada para el PVI dado por $y' = \frac{2x - y}{x}$ y $y(1) = 3$. Se puede observar que la red neuronal aproxima casi perfectamente a la solución del problema.

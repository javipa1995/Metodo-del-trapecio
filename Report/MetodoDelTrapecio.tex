...
\section{Método del trapecio implícito} \label{sec:trapecio-iterativo}
	...
	De nuevo, tomando $h$ lo suficientemente pequeño, se pueden conseguir las hipótesis de las dos aproximaciones previas. Además, esto también asegura que se verifique la Proposición \ref{prop:implicito:error}. 

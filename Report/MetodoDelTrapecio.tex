...
cuando se resuelve mediante el método de Euler, Trapecio Explícito e Iterativo con paso $h=10^{-4}$ se obtienen las siguientes gráficas. 
	...
	\begin{table}[H]
		...
		\end{tabular}
		\caption{Trapecio Explícito e Iterativo y Euler.}
		\label{table:trapecio-ej1}
	\end{table}

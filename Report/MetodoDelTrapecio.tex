...
\section{Motivación: ecuaciones diferenciales ordinarias de primer orden} \label{sec:motivacion}
	...
	El objetivo de este trabajo es desarrollar un método de discretización para aproximar soluciones de problemas de valores iniciales que tenga un mayor orden de precisión que el método de Euler. Previamente, necesitamos conocer algunos resultados básicos sobre la existencia, unicidad y condicionamiento de las soluciones.
...
\section{Introducción al método del trapecio}
...
\section{Método del trapecio explícito}	
...
\section{Método del trapecio iterativo}
	...
	\subsection{Estudio del error} \label{sec:error:iterativo}

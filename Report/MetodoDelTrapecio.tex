...
La resolución de numérica de problemas de valores iniciales puede ser una tarea compleja. Sin embargo, disponemos de métodos como el método de Euler que nos permite calcular una aproximación a la solución. Pese a ello, el coste comptuacional es muy grande y el método del Trapecio, ya se el explícito o el iterativo nos ayuda a conseguir dicha aproximación de forma más rápida y con un menor coste.
